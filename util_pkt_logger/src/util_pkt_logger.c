...
void open_log(void) {
	...
	//sprintf(log_file_name, "pktlog/%s_%s.csv", lgwm_str, iso_date);
	...
	i = fprintf(log_file, "\"node MAC\",\"UTC timestamp\",\"us count\",\"frequency\",\"RF chain\",\"RX chain\",\"size\",\"modulation\",\"bandwidth\",\"datarate\",\"coderate\",\"RSSI\",\"SNR\",\"payload\"\n");
...
//****************************************************begin MQTT section********************************************//	
	...
	char mqtt_message[512 + 1]; /* string with data to brocker */
...
/******************************************begin MQTT section******************************************/
                ...
                else{printf("MQTT message not published %s,%s \n", timebuf,mqtt_message);}
            }
/********************************************end MQTT section*****************************************/
				for (j = 0; j < p->size; ++j) {
